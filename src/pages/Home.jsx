				...
				<ul className="space-y-4 m-2 pt-4">
					{posts.map((post) => (
						<Link
							...
							key={post.slug}
						>
							<li className="post-card border border-[#986315] p-4 rounded-sm bg-[#1A140F] mb-5 transition duration-150 hover:-translate-y-1 hover:scale-100 ease-in-out hover:bg-[#1A140F]/80">
